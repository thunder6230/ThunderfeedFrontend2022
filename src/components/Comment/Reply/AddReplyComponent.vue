...
import type { AddCommentLikeParams, AddPostLikeParams, EditCommentParams } from "@/models/HelperModels";
import EditCommentComponent from "@/components/Comment/EditCommentComponent.vue";
import type { AddCommentParams } from "@/models/HelperModels";
...
<template>
  <li class="flex mt-2">
    ...
    <div :class="TailwindClasses.REPLY_CONTENT_STYLE">
      <input type="text" class="w-full  px-2 py-1 text-amber-900 font-semibold bg-transparent text-lg focus:outline-0" ref="input" @change="handleSubmit" v-model="params.body" >
    </div>
  </li>
</template>
